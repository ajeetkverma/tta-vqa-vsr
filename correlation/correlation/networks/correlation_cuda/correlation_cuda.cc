...
int64_t correlation_forward_cuda(at::Tensor input1, at::Tensor input2, at::Tensor rInput1, at::Tensor rInput2, at::Tensor output,
                       int64_t pad_size,
                       int64_t kernel_size,
...
#ifdef PYTHON_BUILD
int64_t correlation_backward_cuda(at::Tensor& input1, at::Tensor& input2, at::Tensor& rInput1, at::Tensor& rInput2, at::Tensor& gradOutput, 
                       ...
                       int64_t corr_type_multiply)
{
  ...
  int64_t batchSize = input1.size(0);
  int64_t nInputChannels = input1.size(1);
  int64_t paddedInputHeight = input1.size(2)+ 2 * pad_size;
  int64_t paddedInputWidth = input1.size(3)+ 2 * pad_size;

  int64_t height = input1.size(2);
  int64_t width = input1.size(3);
  ...
  int64_t success = correlation_backward_cuda_kernel(gradOutput,
                                                gradOutput.size(0),
                                                gradOutput.size(1),
                                                gradOutput.size(2),
                                                gradOutput.size(3),
...
static auto registry = torch::RegisterOperators("my_ops::correlation_forward_cuda", correlation_forward_cuda);
#endif
