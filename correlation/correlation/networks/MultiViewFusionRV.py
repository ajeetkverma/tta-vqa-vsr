...
class MultiViewFusionRV(nn.Module):
    def __init__(self, batchNorm=True):
        super(MultiViewFusionRV, self).__init__()

        self.batchNorm = batchNorm
        self.conv0 = conv(self.batchNorm, 10, 64)
        ...
        self.predict_flow0 = predict_mv_disparity(16, 4)
