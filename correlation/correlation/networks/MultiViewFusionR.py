...
class MultiViewFusionR(nn.Module):
    def __init__(self, batchNorm=True, input_channels=5):
        super(MultiViewFusionR, self).__init__()
        ...
        self.predict_flow0 = predict_mv_disparity(16)
